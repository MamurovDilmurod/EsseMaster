                ...
                <div className="space-y-8">
                    ...
                    <div className=" relative top-[-65px]">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className=" justify-center px-8 py-5 bg-blue-500 text-white text-base font-semibold rounded-lg 
                       hover:bg-blue-600 transition-all duration-200 transform hover:scale-105 text-center md:hidden flex"
                        >
                            BEPUL QATNASHISH
                        </a>
                    ...
                    <div className="!mt-[-20px]">
                        ...
                        {/* Benefits */}
                        <ul className="space-y-4 text-gray-700 text-lg sm:text-xl font-semibold">
